...
(function() {
  var imagens = [
    "../assets/images/jogoMemoria/facebook.png",
    "../assets/images/jogoMemoria/android.png",
    "../assets/images/jogoMemoria/chrome.png",
    "../assets/images/jogoMemoria/firefox.png",
    "../assets/images/jogoMemoria/html5.png",
    "../assets/images/jogoMemoria/googleplus.png",
    "../assets/images/jogoMemoria/twitter.png",
    "../assets/images/jogoMemoria/windows.png",
    "../assets/images/jogoMemoria/cross.png"
  ];
...
function initializeBoard() {
  ...
  if (app.cards.length <= 0) {
    app.imagens.forEach(img => {
      if (img !== "../assets/images/jogoMemoria/cross.png") app.cards.push(img);
    });
...
function mountCardHtml(card, index) {
  ...
  cardBack.setAttribute("src", "../assets/images/jogoMemoria/cross.png");
